<script lang="ts" context="module">
  ...
  export const exampleTemplate: Template = {
    metrics: [
      ...
      { name: "Team", type: "text", group: "Misc" },
      { name: "Drive System", type: "text", group: "Misc"},
      { name: "Arm", type: "text", group: "Misc"},
      { name: "Weight", type: "number", group: "Misc"},
      ...
      { name: "Bottom Points", type: "number", group: "Auto"},
      { name: "Top Points", type: "number", group: "Teleop"},
      { name: "Middle Points", type: "number", group: "Teleop"},
      { name: "Bottom Points", type: "number", group: "Teleop"},
